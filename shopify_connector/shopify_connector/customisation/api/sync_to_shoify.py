...
# def send_contact_to_shopify(contact_name):
...
#         frappe.msgprint("Contact sent to Shopify successfully!")
#     else:
#         frappe.throw(f"Failed to send contact. Status: {response.status_code}, Msg: {response.text}")
